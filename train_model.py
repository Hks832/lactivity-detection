...
model.add(Conv3D(64, kernel_size=(3, 3, 3), activation='relu', input_shape=(final_seq, img_height, img_width, 3)))
...
history = model.fit(x = X_train, y = y_train, epochs=50, batch_size = 16 , shuffle=True, validation_split=0.10, callbacks=callbacks)

print("[INFO]...Model is saving:")
model.save("Surveillance_trained_model_3DCNN.h5")
